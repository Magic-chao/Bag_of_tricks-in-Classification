...
class CUBDataSet_Train(dataset.Dataset):
    """
    ...
    """
    def __init__(self,
                 root=os.path.join("/mnt/workspace/zengzhichao/Bag_of_tricks", "datasets", "CUB_200_2011"),
                 mode="train",
                 transform=None):
        super(CUBDataSet_Train, self).__init__()
