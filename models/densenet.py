...
class DenseNet(HybridBlock)
    rDensenet-BC model from the
    `Densely Connected Convolutional Networks httpsarxiv.orgpdf1608.06993.pdf`_ paper.
...
def get_densenet(num_layers, pretrained=False, ctx=cpu(),
    ...
    root  str, default $MXNET_HOMEmodels
...
def densenet121(kwargs)
    rDensenet-BC 121-layer model from the
    `Densely Connected Convolutional Networks httpsarxiv.orgpdf1608.06993.pdf`_ paper.
...
def densenet161(kwargs)
    rDensenet-BC 161-layer model from the
    `Densely Connected Convolutional Networks httpsarxiv.orgpdf1608.06993.pdf`_ paper.
...
def densenet169(kwargs)
    rDensenet-BC 169-layer model from the
    `Densely Connected Convolutional Networks httpsarxiv.orgpdf1608.06993.pdf`_ paper.
...
def densenet201(kwargs)
    rDensenet-BC 201-layer model from the
    `Densely Connected Convolutional Networks httpsarxiv.orgpdf1608.06993.pdf`_ paper.
